...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $lapangan123 = Court::create(["name" => "Lapangan 123", "address" => "Jalan 123, Bandung", "open" => "06:00:00", "close" => "21:00:00", "operational_days" => json_encode(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]), "categories" => json_encode(["Football", "Basketball", "Badminton", "Gymnastics", "Volleyball", "Tennis"]), "rent_per_hour" => 40000]);
        $gor69 = Court::create(["name" => "Gor 69", "address" => "Jalan 69, Bandung", "open" => "08:00:00", "close" => "20:00:00", "operational_days" => json_encode(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]), "categories" => json_encode(["Football", "Basketball", "Badminton", "Volleyball", "Tennis"]), "rent_per_hour" => 50000]);
        $griyasportcenter = Court::create(["name" => "Griya Sport Center", "address" => "Taman Kopo Indah, Bandung", "open" => "07:00:00", "close" => "13:00:00", "operational_days" => json_encode(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]), "categories" => json_encode(["Football", "Basketball", "Badminton", "Volleyball", "Swimming"]), "rent_per_hour" => 35000]);
